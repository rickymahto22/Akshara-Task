...
4. Add Render Environment Variables:
   ...
   - `ADMIN_NAME`, `ADMIN_EMAIL`, `ADMIN_PASSWORD` (optional but recommended)
5. Deploy. Render will give you a backend URL like:
...
2. Configure:
   ...
   - Framework preset: Vite/React (Vercel auto-detects)
3. Add Vercel Environment Variable:
   - `VITE_API_BASE_URL` = your Render backend API base:
     - Example: `https://your-backend.onrender.com/api`
4. Deploy. Vercel will give you a frontend URL like:
